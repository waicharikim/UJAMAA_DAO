...
export const SelectGoodsServicesSchema = z.object({
  goodsServiceIds: z
    .array(z.string().uuid())
...
export type RequestResidenceChangeDto = z.infer<typeof RequestResidenceChangeSchema>;
export type SetTemporaryLocationDto = z.infer<typeof SetTemporaryLocationSchema>;
