...
export async function getMyProfile(req: AuthRequest, res: Response) {
  ...
  try {
    ...
    logger.error(
      { operationType: "USER_PROFILE", userId, error: error instanceof Error ? error.message : String(error) },
...
export async function getUserProfile(req: AuthRequest, res: Response) {
  ...
  try {
    ...
    logger.error(
      { operationType: "USER_PROFILE", userId, requesterId, error: error instanceof Error ? error.message : String(error) },
