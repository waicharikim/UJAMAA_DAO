 ...
 */
export async function requestCommunityVerification(req: AuthRequest, res: Response) {
  ...
  try {
    ...
    logger.error(
      { operationType: "USER_VERIFICATION", userId, error: error instanceof Error ? error.message : String(error) },
...
export async function vouchForUser(req: AuthRequest, res: Response) {
  ...
  try {
    ...
    logger.error(
      { operationType: "USER_VERIFICATION", voucherId, error: error instanceof Error ? error.message : String(error) },
 ...
 */
export async function processVerificationPayment(req: AuthRequest, res: Response) {
  const userId = req.user!.userId;
  const dto = req.body;
