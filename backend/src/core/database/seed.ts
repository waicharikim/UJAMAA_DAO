...
const ONBOARDING_TUTORIALS_DATA = [
  ...
  // ── Contextual section tours (category TOUR) ──────────────────────────────
  // Completion is tracked here so each tour auto-runs once per user and rewards PR.
  // The actual step content + DOM anchors live in the frontend (frontend/lib/tours).
  {
    key: 'dashboard_tour',
  ...
  },
  {
    ...
    description: 'A quick walkthrough of your ward, the hierarchy, and groups.',
    category: 'TOUR',
    order: 21,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    ...
    description: 'A quick walkthrough of proposals and voting.',
    category: 'TOUR',
    order: 22,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    key: 'profile_tour',
    title: 'Profile tour',
    description: 'A quick walkthrough of verification and your first steps.',
    category: 'TOUR',
    order: 23,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    key: 'projects_tour',
    title: 'Projects tour',
    description: 'A quick walkthrough of projects.',
    category: 'TOUR',
    order: 24,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    ...
    title: 'Marketplace tour',
    description: 'A quick walkthrough of the marketplace.',
    category: 'TOUR',
    order: 25,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    key: 'education_tour',
    title: 'Learning tour',
    description: 'A quick walkthrough of learning modules.',
    category: 'TOUR',
    order: 26,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    key: 'treasury_tour',
    title: 'Treasury tour',
    description: 'A quick walkthrough of the treasury.',
    category: 'TOUR',
    order: 27,
    ipReward: 0,
    prReward: 3,
  ...
  {
    key: 'elections_tour',
    title: 'Elections tour',
    description: 'A quick walkthrough of elections.',
    category: 'TOUR',
    order: 28,
    ipReward: 0,
    prReward: 3,
  ...
  {
    key: 'emergency_tour',
    title: 'Emergency tour',
    description: 'A quick walkthrough of emergency alerts.',
    category: 'TOUR',
    order: 29,
    ipReward: 0,
    prReward: 3,
  ...
  },
  {
    ...
    title: 'Proposal detail tour',
    description: 'A quick walkthrough of reading and voting on a proposal.',
    category: 'TOUR',
    order: 30,
    ipReward: 0,
    prReward: 3,
