...
const USERS = [
  {
    email: 'geo.boito@sweep.test',
    name: 'Boito Tester',
    wardId: '998333e2-3be1-4052-a237-de73916b47c8',
  },
  {
    email: 'geo.chepchabas@sweep.test',
    name: 'Chepchabas Tester',
    wardId: '53002fed-aa61-49e8-92b8-5c94c1391665',
  },
  {
    email: 'geo.chebunyo@sweep.test',
    name: 'Chebunyo Tester',
    wardId: 'b84a1576-d467-4eb9-96b5-8067eea5f6cb',
  },
  {
    email: 'geo.airbase@sweep.test',
    name: 'Airbase Tester',
    wardId: '81b8bd74-0b83-4858-a3af-51dadaefc482',
  },
];
...
async function main() {
  for (const u of USERS) {
    ...
    console.log(
      `✓ ${u.email.padEnd(28)} id=${user.id}  systemGroups=${groups}`
    );
  }
  console.log(
