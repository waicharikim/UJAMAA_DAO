...
const GREETING =
  "Habari! I'm BarazaBot. Ask me about your communities — proposals, elections, treasury, past decisions, or how UjamaaDAO works."
    ...
    <>
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-label="BarazaBot assistant"
        >
          {/* Header */}
          <div
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="leading-tight">
                <p className="text-sm font-bold">BarazaBot</p>
